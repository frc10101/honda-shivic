#ifndef H_XBOX_CONTROLLER
#define H_XBOX_CONTROLLER
 ...
 * gamepad.
 */
class RRXboxController : public frc::Joystick {
    public:
        ...
        RRXboxController(unsigned port);
        virtual ~RRXboxController();
